...
| Release Gate | Confirm the repository is ready to publish | lint, full test run, version consistency, docs contract | `references/release-checklist.md`, `runbooks/README.md` |
